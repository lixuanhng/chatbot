...
@version :   暂时去掉了代码中打印 tf.logging 的相关代码
...
os.environ['CUDA_VISIBLE_DEVICES'] = '3'  # or any '0,1,2'
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'  # or any {'0', '1', '2'}  # 屏蔽tensorflow中的所有信息
